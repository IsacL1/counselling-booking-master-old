...
mongoose.Promise = global.Promise; // Ken's DB

process.env.MONGO_URI = 'mongodb://ken:elam0417@' + 'ac-j7lsw52-shard-00-00.wxgkica.mongodb.net:27017,' + 'ac-j7lsw52-shard-00-01.wxgkica.mongodb.net:27017,' + 'ac-j7lsw52-shard-00-02.wxgkica.mongodb.net:27017/' + '?ssl=true&replicaSet=atlas-9oo61t-shard-0&authSource=admin&retryWrites=true&w=majority'; // Is' DB
